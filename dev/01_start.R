...
golem::fill_desc(
  pkg_name = "spex", # The Name of the package containing the App 
  pkg_title = "spex data exploration", # The Title of the package containing the App 
  pkg_description = "Exploration of data sets.", # The Description of the package containing the App 
